...
class SellersControllerTest < ActionController::TestCase
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post :create, seller: { department_id: @seller.department_id, email: @seller.email, name: @seller.name, phone: @seller.phone, phone_ext: @seller.phone_ext }
    end
  ...
  test "should update seller" do
    put :update, id: @seller, seller: { department_id: @seller.department_id, email: @seller.email, name: @seller.name, phone: @seller.phone, phone_ext: @seller.phone_ext }
    assert_redirected_to seller_path(assigns(:seller))
  end
