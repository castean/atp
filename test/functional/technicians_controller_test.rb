...
class TechniciansControllerTest < ActionController::TestCase
  ...
  test "should create technician" do
    assert_difference('Technician.count') do
      post :create, technician: { email: @technician.email, name: @technician.name, nextel: @technician.nextel, phone: @technician.phone }
    end
  ...
  test "should update technician" do
    put :update, id: @technician, technician: { email: @technician.email, name: @technician.name, nextel: @technician.nextel, phone: @technician.phone }
    assert_redirected_to technician_path(assigns(:technician))
  end
